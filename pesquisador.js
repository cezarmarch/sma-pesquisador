...
// Pesquisa as pautas via Claude com web search
  ...
  "pautas": [
    {
      ...
      "angulo": "Como transformar isso em post: ex: carrossel educativo mostrando os 5 sinais de fraude no consignado",
...
// Monta o email HTML com as pautas
...
async function executarPesquisador(sugestao) {
  ...
  // Envia email avisando que vai começar e pergunta sugestão
  if (!sugestao) {
